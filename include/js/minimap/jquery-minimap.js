(function( $ ) {
	$.fn.minimap = function( $mapSource ) {
		...
		function init() {
			...
			console.log($mapSource.children());
			$mapSource.children().each( function() {
				var $child = $( this );
				var mini = $( "<img id='id_map_img' src='/commonfiles/map/MAIN_B0001.png' style='height:100%; transform:scale(1.0, 1.0)'>").addClass( "minimap-node" );
				$minimap.append( mini );
