                ...
                if(child1.nodeType == 1){
                    ...
                    if(child1.nodeName == "HEADER"){
                        ...
                        while(child2 != null && child2.nodeType != 4){
                            ...
                            if(xml_obj.header.B_CODE == "") xml_obj.header.B_CODE = "B0001";
                        ...
                        while(child2 != null && child2.nodeType != 4){
                            if(child2.nodeName == "STORE_INFO"){
                                ...
                                while(child3 != null && child3.nodeType != 4){
                                    ...
                                    if(child3.nodeName == "STORE_SUB0001_URL") if(child3.childNodes[0]) CObj[child3.nodeName] = child3.childNodes[0].nodeValue;
                                ...
                                if(CObj.B_CODE == "") CObj.B_CODE = "B0001";

                                CObj.STORE_LOGO_URL = this.getCvtXmlTag(CObj.STORE_LOGO_URL);
                                CObj.STORE_SUB0001_URL = this.getCvtXmlTag(CObj.STORE_SUB0001_URL);
