...
class Eltov2DFloor{
    ...
    setInitSetting(){
        ...
        if(this.m_my_conf.kiosk_floor != ""){
            ...
            i_tmp = this.m_my_conf.kiosk_pos_y - 80;
        ...
        if(p_type == "HIDE"){
            ...
            if(this.m_my_conf.is_mobile == false){
                if(p_type == "INIT"){
                    ...
                    this.m_main_disp.style.transform = "translate(" + (0) + "px," + (this.m_my_conf.top) + "px) scale(" + this.m_my_conf.scale_real + "," + this.m_my_conf.scale_real + ")";
                }
                this.m_main_container.style.transform = "translate(" + (0 - this.m_my_conf.map_width/2) + "px," + (0 - this.m_my_conf.map_height/2) + "px)";
            }else{
                if(p_type == "INIT"){
